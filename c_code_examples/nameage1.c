...
/*
 * Example of complex qsort using a struct
 * Has hard-coded limits, mainly "person" is limited
 * to a size of MAXPERSON
 *
 * This limitation is removed in nameage2.c
 */
...
int main(int argc, char *argv[]) {
	...
	char *line;
	char *ptr;
	struct person_type *person[MAXPERSON];
